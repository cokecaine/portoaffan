...
export const projects: Project[] = [
  {
    ...
    description: 'Analysis of customer lifetime value patterns and revenue prediction modeling',
  ...
  },
  {
    ...
    description: 'Real-time dashboard for tracking sales metrics and KPI trends',
  ...
  },
  {
    ...
    description: 'Machine learning model to predict customer churn with feature engineering',
